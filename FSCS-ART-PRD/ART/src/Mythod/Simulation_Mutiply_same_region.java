...
public class Simulation_Mutiply_same_region {
	...
	public Simulation_Mutiply_same_region(ArrayList<Dimension> dim_list, double failrate, int number) {
		/*
		 * 求输入域面积，这是共存在步骤
		 */
...
//			temp = new Simulation_Mutiply_same_region(list, failrate,a).run();
//			result.add(temp);
...
class ThreadWithCallback implements Callable{
	...
	ThreadWithCallback(ArrayList<Dimension> list,double fail_rate){
		this.list=list;
	...
	public Object call() throws Exception {
		...
		int temp=new Simulation_Mutiply_same_region(list,fail_rate,90).run();
		return temp;
	}
