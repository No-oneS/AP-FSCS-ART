...
public class Simulation_Mutiply_differet_region {
	...
	public Simulation_Mutiply_differet_region(ArrayList<Dimension> dim_list, double failrate, int number) {
		/*
		 * 求输入域面积，这是共存在步骤
		 */
	...
	public static void main(String args[]) {
		...
		for (int i = 1; i <= times; i++) {
			temp = new Simulation_Mutiply_differet_region(list, failrate,a).run();
			result.add(temp);
