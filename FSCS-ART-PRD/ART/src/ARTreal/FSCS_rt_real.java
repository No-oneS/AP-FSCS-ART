...
//	airy real = new airy();			// 初始化真实程序类
	...
	public FSCS_rt_real(double[][]  bd, double failrate, int fail_number){
...
//					if(real.Produces_Error((double)testcase.list.get(0), (double)testcase.list.get(1), (double)testcase.list.get(2), (double)testcase.list.get(3))){
//						count++;
//						return count;
//					}
//					
...
//			mindist = mindist > band_dist ? band_dist : mindist;	
	...
	static class ThreadWithCallback implements Callable{
		...
		public Object call() throws Exception {
			...
			int temp=new FSCS_rt_real(list,fail_rate,fail_number).run();;
			return temp;
		}
	}
	...
	public static void main(String args[]){
		...
		double failrate= real_Parameters.failure_rate_airy; 		// 不同的真实程序缺陷率不同，注意改
