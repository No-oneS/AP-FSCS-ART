...
public class FSCS_dt_bound_center_real_k_10_final_9_for_bound{
...
//	airy real = new airy();			// 初始化真实程序类
	...
	public FSCS_dt_bound_center_real_k_10_final_9_for_bound(double[][]  bd, double failrate, int fail_number){
...
//        }  
	...
	static class ThreadWithCallback implements Callable{
		...
		public Object call() throws Exception {
			...
			int[] temp=new FSCS_dt_bound_center_real_k_10_final_9_for_bound(list,fail_rate,fail_number).run();;
...
//				System.out.println("future.take() = " + future.get() );
		...
		System.out.println("FSCS_dt_bound_center_real_k_10_final_9_for_bound failrate ： "+ failrate +" ,fail_number "+fail_number+"\nFm: " + sums / (double) times+"  且最后的Fart/Frt: "+sums / (double) times*failrate);// 平均每次使用的测试用例数
		System.out.println("Time : "+(endTime - startTime) / (double)times );
		
		java.io.File file2 = new java.io.File("FSCS_dt_bound_center_data/real_software/FSCS_dt_bound_center_real_k_10_final_data/FSCS_dt_bound_center_real_k_10_final_9_for_bound_airy.txt");
		try {
